# Radiomics Features Extraction for PET/CT and PET/MR systems with the 3D-Printed Phantom.
...
def main_code():
    ...
    params_path = os.path.join(seg_ref_main_path, 'Params.yaml')    # radiomic parameter file path
