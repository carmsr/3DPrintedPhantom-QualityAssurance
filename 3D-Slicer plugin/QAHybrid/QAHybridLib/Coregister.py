# Co-registration analysis for PET/CT and PET/MR systems (DICOM images): 3D-Printed Phantom.
...
class OptionDialog(tk.Toplevel):
    def __init__(self, parent, title, prompt, options):
        ...
        # Obtener el ancho requerido por el widget de etiqueta
        label_width = self.label.winfo_reqwidth()

        # Calcular el ancho de la ventana en función del ancho requerido por el widget de etiqueta
        window_width = label_width + 50  # Ajusta este valor según tus necesidades

        self.geometry(f"{window_width}x100")  # Ajustar la anchura de la ventana
